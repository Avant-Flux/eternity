...
dependency_installer="$install_command $ruby_dev $ruby_opengl $gosu $texplay $nokogiri"

eval $dependency_installer &&

sudo gem install rake gosu chingu chipmunk texplay eventmachine require_all ffi-swig-generator
