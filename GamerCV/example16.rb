...
class Game < Chingu::Window
  def initialize
    ...
    #
    @high_score_list = OnlineHighScoreList.load(:game_id => 11, :login => "ETERNITY", :password => "GateOfMana", :limit => 20)
	#~ if @high_score_list[0] == nil
      #~ 5.times do |i|
        #~ @high_score_list << { :name => "BZR", :score => (i+1)*50}
      #~ end
    #~ end
    create_text
  end  
